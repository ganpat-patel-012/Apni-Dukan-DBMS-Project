...
<body>
    ...
    <form method="post">
        ...
        <div class="form-group"><input class="form-control" type="text" name="e_mobile" placeholder="Enter your Mobile number"></div>
        <div class="form-group"><input class="form-control" type="password" name="e_pswd" placeholder="Enter your Password"></div>
