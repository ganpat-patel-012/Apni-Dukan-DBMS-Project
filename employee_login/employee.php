            ...
            <div class="container-fluid"><img id="logo" src="assets/img/images.png"><a class="navbar-brand" id="brand" href="/AD/index.php"><strong>Apni Dukaan</strong></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active" href="updateemployee.php"><strong>Edit Profile</strong></a></li>
                        ...
                        <div class="card shadow border-left-primary py-2" style="background-color: rgba(0,0,0,0);">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1" style="width: 300px;"><span class="text-capitalize text-center" style="font-size: 25px;color: rgb(1,5,15);">&nbsp; Generate invoice&nbsp;</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0" style="width: 290px;">
                                            <a href="twostep.php"><button class="btn btn-primary" type="button"style="background-color: rgb(52,57,72);margin-left: 10px;" >Generate Invoice</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
